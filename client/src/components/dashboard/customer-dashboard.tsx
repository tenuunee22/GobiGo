  ...
  return (
    <div className="min-h-screen pt-20 pb-20">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)), url("https://example.com/food-background.jpg")',
            ...
            >
              <motion.button
                onClick={(e) => {
                  ...
                  window.open("https://example.com/socialmedia", "_blank");
                }}
